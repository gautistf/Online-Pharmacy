...
<html lang="en">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
	...
	<link rel="stylesheet" href="css/index.css?1422585377">
          ...
          <div class="row align-items-center">
            ...
            <div class="text-right col-6 col-md-4 order-3 order-md-3">
              ...
              <ul>
                  ...
                  <div id="text" style="color: black; font-weight: bold;">Sign IN</div>
                  </li>

                  <li><a href="cart.php" class="site-cart"><span class="glyphicon glyphicon-shopping-cart"></span></a>
                  <div id="text" style="color: black; font-weight: bold">Cart</div>
                  </li>
                  
                  <li><a href="logout.php"><span class="glyphicon glyphicon-log-out"></span></a>
                  <div id="text" style="color: black; font-weight: bold">LogOut</div></li>
      ...
      <div class="container">
		...
		<?php
		 ...
		 ?>
          ...
          <a href="admin/login.php" ><span class="center-text" style="text-decoration: underline; color: #8a2be2 ;">  Are you an admin? </span></a> 
				  </div>
