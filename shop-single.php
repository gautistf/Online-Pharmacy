    ...
    <div class="site-section">
      <div class="container">
        ...
        <form action="cart.php" method="post">
            ...
            <div class="col-md-6">
              <h2 class="text-black" style="font-weight: bold; font-size: 4rem; text-decoration: underline; "><?php echo $product_array['product_name']; ?></h2>
              <p  class="mb-4" style="font-family: Arial; font-size: 1.8rem; color:#111010;"><?php echo $product_array['product_description']; ?></p>
              <p><strong class="text-primary h4" style="font-size: 3rem;">₹<?php echo $product_array['product_cost']; ?></strong></p>
              ...
              <div class="mb-5">
                  ...
                  <input class="form-control text-center" style="margin: 0;" name="quantity" value="1"  placeholder="" >
